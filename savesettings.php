...
function isinserverlist($addr) {
	...
	$DNSserverslist = [
"114" => ["v4_1" => "114.114.114.114","v4_2" => "114.114.115.115"],
"DNSpod" => ["v4_1" => "119.29.29.29","v4_2" => "119.28.28.28"],
"闃块噷DNS" => ["v4_1" => "223.5.5.5","v4_2" => "223.6.6.6"],
"PdomoDNS" => ["v4_1" => "101.132.183.99","v4_2" => "47.98.124.222"],
"涓澶ч槻姹℃煋DNS" => ["v4_1" => "202.141.162.123","v4_2" => "202.141.176.93"],
"OneDNS" => ["v4_1" => "117.50.10.10","v4_2" => "117.50.20.20"],
"DNS娲?鐢典俊" => ["v4_1" => "101.226.4.6","v4_2" => "218.30.118.6"],
"DNS娲?鑱旈€? => ["v4_1" => "123.125.81.6","v4_2" => "140.207.198.6"],
"XsicoDNS" => ["v4_1" => "182.254.242.15"],
"DNS over Https" => ["v4_1" => "127.0.0.1#5380"]
		];
